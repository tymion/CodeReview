void SunPointingKF(MatrixMath_s* dipoleComm, MatrixMath_s angrate_s, MatrixMath_s r_e2s,  Quaternion_s qEst, MatrixMath_s b_sEst, MatrixMath_s Inertia_ref, ctrlgains_s* ctrlgains, MatrixMath_s angrate) {
  MatrixMath_s A_i2s = {
    {0, 0, 0,
     0, 0, 0,
     0, 0, 0},
